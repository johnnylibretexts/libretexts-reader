...
export function MiniPlayer({ onClose }: MiniPlayerProps) {
  ...
  return (
    <footer className="flex min-h-16 items-center justify-between gap-4 border-t border-neutral-200 bg-white px-5 dark:border-neutral-800 dark:bg-neutral-950">
