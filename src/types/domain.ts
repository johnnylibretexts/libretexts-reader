...
export type AppErrorKind = "database" | "pool" | "io" | "serde" | "http" | "readability" | "epub" | "pdf" | "openstax" | "libretexts" | "model" | "voice" | "auth" | "tts" | "drm_protected" | "tauri" | "invalid_input" | "migration";
